      ...
      <div className="thq-flex-column thq-section-max-width">
        <div className="contact-form5-section-title thq-flex-column">
          <span className="thq-body-small">
            {props.content2 ?? (
              <Fragment>
                <span className="contact-form5-text22">
          ...
          <div className="contact-form5-content">
            <h2 className="thq-heading-2">
              {props.heading1 ?? (
                <Fragment>
                  <span className="contact-form5-text20">Contact us</span>
                </Fragment>
              )}
            </h2>
        ...
        <form className="contact-form5-form thq-flex-column">
          ...
          >
            <span className="thq-body-small">
              {props.action ?? (
                <Fragment>
                  <span className="contact-form5-text21">Submit</span>
                </Fragment>
              )}
            </span>
          </button>
...
ContactForm5.propTypes = {
  ...
  contactForm5Id: PropTypes.string,
}
