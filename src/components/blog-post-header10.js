    ...
    >
      <div className="blog-post-header10-max-width thq-section-max-width">
        <h3 className="blog-post-header10-heading thq-heading-2">
          {props.category ?? (
            <Fragment>
              <span className="blog-post-header10-text3">Events</span>
            </Fragment>
          )}
        </h3>
        <div className="thq-flex-row blog-post-header10-card">
          ...
          <div className="blog-post-header10-content thq-flex-column">
            <h1 className="thq-heading-1 blog-post-header10-title">
              {props.blogPostTitle ?? (
                <Fragment>
                  <span className="blog-post-header10-text2">
                    Personalize Your Event with Custom Digital Portrait Place
                    Cards
                  </span>
                </Fragment>
              )}
            ...
            <span className="blog-post-header10-author-name thq-body-small">
              {props.avatarName ?? (
                <Fragment>
                  <span className="blog-post-header10-text1">
                    Digital Portrait Place Cards
                  </span>
                </Fragment>
              )}
            </span>
            <div className="blog-post-header10-share-buttons thq-flex-row">
...
BlogPostHeader10.defaultProps = {
  ...
  category: undefined,
  blogPostImageSrc:
    'https://images.unsplash.com/photo-1527239441953-caffd968d952?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1NTExNDc3MXw&ixlib=rb-4.1.0&q=80&w=1080',
  rootClassName: '',
}
