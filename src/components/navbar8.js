        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            >
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text27">Our Story</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar8-text16">Gallery</span>
                </Fragment>
              )}
            </a>
            <a
          ...
          <div className="navbar8-buttons1">
            ...
            <button className="navbar8-action21 thq-button-animated thq-button-outline">
              ...
              >
                {props.text1 ?? (
                  <Fragment>
                    <span className="navbar8-text19">View Packages</span>
                  </Fragment>
                )}
              </a>
            </button>
        ...
        <div data-thq="thq-mobile-menu" className="navbar8-mobile-menu">
          <div className="navbar8-nav">
            ...
            <nav className="navbar8-links2">
              <a
                href={props.link1Url}
                className="navbar8-link13 thq-body-small thq-link"
              >
                {props.link1 ?? (
                  <Fragment>
                    <span className="navbar8-text21">Home</span>
                      ...
                      <div className="navbar8-menu-item2">
                        ...
                        <div className="navbar8-content2">
                          <span className="navbar8-page21 thq-body-large">
                            {props.page2 ?? (
                              <Fragment>
                                <span className="navbar8-text26">About Us</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                      ...
                      <div className="navbar8-menu-item4">
                        ...
                        <div className="navbar8-content4">
                          <span className="navbar8-page41 thq-body-large">
                            {props.page4 ?? (
                              <Fragment>
                                <span className="navbar8-text28">Contact</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
		 ...
		 <span>
                  {props.action1 ?? (
                    <Fragment>
                      <span className="navbar8-text22">Start your Order</span>
                    </Fragment>
                  )}
                </span>
		</a>
              ...
              <button className="thq-button-outline">
                <span>
                  {props.action2 ?? (
                    <Fragment>
                      <span className="navbar8-text25">View Packages</span>
                    </Fragment>
                  )}
                </span>
              </button>
...
Navbar8.defaultProps = {
  ...
  link31: undefined,
  page3ImageSrc:
    'https://images.unsplash.com/photo-1617785258979-b50ebd43871e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1NTExNDQzMXw&ixlib=rb-4.1.0&q=80&w=1080',
  page1: undefined,
  link1Url: '#home',
  ...
  page1ImageSrc:
    'https://images.unsplash.com/photo-1588610521245-b1bad0d62832?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1NTExNDQzMHw&ixlib=rb-4.1.0&q=80&w=1080',
  text1: undefined,
  ...
  linkUrlPage1: '#home',
  page4ImageSrc:
    'https://images.unsplash.com/photo-1651534400411-eaf227f82ee4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1NTExNDQzMXw&ixlib=rb-4.1.0&q=80&w=1080',
  ...
  page2ImageSrc:
    'https://images.unsplash.com/photo-1581814706561-f5bbfa7d984a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1NTExNDQzMXw&ixlib=rb-4.1.0&q=80&w=1080',
  page4: undefined,
