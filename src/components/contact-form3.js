          ...
          <form className="thq-card">
            ...
            >
              <span className="thq-body-small">
                {props.action ?? (
                  <Fragment>
                    <span className="contact-form3-text20">/contact</span>
                  </Fragment>
                )}
              </span>
            </button>
...
ContactForm3.defaultProps = {
  ...
  content2: undefined,
  imageSrc:
    'https://images.unsplash.com/photo-1613978165293-ef7935b952b1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1NTMwMTE0N3w&ixlib=rb-4.1.0&q=80&w=1080',
  action: undefined,
  imageAlt: 'Image1',
}
