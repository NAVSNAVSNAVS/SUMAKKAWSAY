...
Logos1.defaultProps = {
  logo2Alt: 'Custom Portrait Place Cards Logo',
  logo3Src:
  ...
  logo3Alt: 'Personalized Event Place Cards Logo',
  logo6Alt: 'Celebratory Event Logo',
  heading1: undefined,
  rootClassName: '',
  logo4Alt: 'Unique Keepsakes Logo',
  logo1Alt: 'Digital Portrait Place Cards Logo',
  logo5Alt: 'Connection and Harmony Logo',
  logo1Src:
