...
import './blog-post-header8.css'

const BlogPostHeader8 = (props) => {
  return (
    <div
      className={`blog-post-header8-blog-post-header3 thq-section-padding ${props.rootClassName} `}
    >
      <div className="blog-post-header8-max-width thq-section-max-width">
        <div className="blog-post-header8-content thq-flex-column">
          ...
          <span className="blog-post-header8-author-name thq-body-small">
            {props.authorName ?? (
              <Fragment>
                <span className="blog-post-header8-text2">Emily Smith</span>
              </Fragment>
            )}
          </span>
          <div className="blog-post-header8-share-buttons thq-flex-row">
        ...
        <img
          ...
          className="blog-post-header8-image thq-img-ratio-4-3"
        />
      </div>
    </div>
  )
...
BlogPostHeader8.defaultProps = {
  ...
  blogPostImageSrc:
    'https://images.unsplash.com/photo-1653719883870-5da2720911ba?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1NTExNTEyNXw&ixlib=rb-4.1.0&q=80&w=1080',
  blogPostImageAlt: 'Digital Portrait Place Cards at Event',
  rootClassName: '',
}
